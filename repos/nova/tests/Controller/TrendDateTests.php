...
trait TrendDateTests
{
    ...
    public function test_trend_count_can_be_retrieved_by_month_with_timezone($date)
    {
        ...
        $this->assertEquals(
            1,
            $response->original['value']->trend[Chronos::now()->setTimezone(
                'America/Chicago'
            )->subMonths(5)->format('F Y')]
        );
        $this->assertEquals(
            0,
            $response->original['value']->trend[Chronos::now()->setTimezone(
                'America/Chicago'
            )->subMonths(4)->format('F Y')]
        );
        $this->assertEquals(
            0,
            $response->original['value']->trend[Chronos::now()->setTimezone(
                'America/Chicago'
            )->subMonths(3)->format('F Y')]
        );
        $this->assertEquals(
            0,
            $response->original['value']->trend[Chronos::now()->setTimezone(
                'America/Chicago'
            )->subMonths(2)->format('F Y')]
        );
        $this->assertEquals(
            0,
            $response->original['value']->trend[Chronos::now()->setTimezone(
                'America/Chicago'
            )->subMonths(1)->format('F Y')]
        );
        $this->assertEquals(
            1,
            $response->original['value']->trend[Chronos::now()->setTimezone('America/Chicago')->format(
                'F Y'
            )]
        );
    ...
    public function test_trend_count_can_be_retrieved_by_week($date)
    {
        ...
        $this->assertEquals(
            1,
            $response->original['value']->trend[$startingDate->format(
                'F j'
    ...
    public function test_trend_count_can_be_retrieved_by_hours_with_timezone($date)
    {
        ...
        $this->assertEquals(
            ...
            $response->original['value']->trend[Chronos::now()->setTimezone(
                'America/Chicago'
            )->subHours(4)->format('F j - G:00')]
        );
        $this->assertEquals(
            0,
            $response->original['value']->trend[Chronos::now()->setTimezone(
                'America/Chicago'
            )->subHours(3)->format('F j - G:00')]
        );
        $this->assertEquals(
            0,
            $response->original['value']->trend[Chronos::now()->setTimezone(
                'America/Chicago'
            )->subHours(2)->format('F j - G:00')]
        );
        $this->assertEquals(
            0,
            $response->original['value']->trend[Chronos::now()->setTimezone(
                'America/Chicago'
            )->subHours(1)->format('F j - G:00')]
        );
        $this->assertEquals(
            1,
            $response->original['value']->trend[Chronos::now()->setTimezone('America/Chicago')->format(
    ...
    public function test_trend_count_can_be_retrieved_by_minute_with_timezone($date)
    {
        ...
        $this->assertEquals(
            ...
            $response->original['value']->trend[Chronos::now()->setTimezone(
                'America/Chicago'
            )->subMinutes(4)->format('F j - G:i')]
        );
        $this->assertEquals(
            0,
            $response->original['value']->trend[Chronos::now()->setTimezone(
                'America/Chicago'
            )->subMinutes(3)->format('F j - G:i')]
        );
        $this->assertEquals(
            0,
            $response->original['value']->trend[Chronos::now()->setTimezone(
                'America/Chicago'
            )->subMinutes(2)->format('F j - G:i')]
        );
        $this->assertEquals(
            0,
            $response->original['value']->trend[Chronos::now()->setTimezone(
                'America/Chicago'
            )->subMinutes(1)->format('F j - G:i')]
        );
        $this->assertEquals(
            1,
            $response->original['value']->trend[Chronos::now()->setTimezone('America/Chicago')->format(
    ...
    public function test_trend_count_can_be_retrieved_by_minute_in_12_hour_time($date)
    {
        ...
        $this->assertEquals(
            1,
            $response->original['value']->trend[Chronos::now()->subMinutes(4)->format('F j - g:i A')]
        );
        $this->assertEquals(
            0,
            $response->original['value']->trend[Chronos::now()->subMinutes(3)->format('F j - g:i A')]
        );
        $this->assertEquals(
            0,
            $response->original['value']->trend[Chronos::now()->subMinutes(2)->format('F j - g:i A')]
        );
        $this->assertEquals(
            0,
            $response->original['value']->trend[Chronos::now()->subMinutes(1)->format('F j - g:i A')]
        );
    ...
    public function test_trend_count_can_be_retrieved_by_minute_in_12_hour_time_and_timezone($date)
    {
        ...
        $this->assertEquals(
            ...
            $response->original['value']->trend[Chronos::now()->setTimezone(
                'America/Chicago'
            )->subMinutes(4)->format('F j - g:i A')]
        );
        $this->assertEquals(
            0,
            $response->original['value']->trend[Chronos::now()->setTimezone(
                'America/Chicago'
            )->subMinutes(3)->format('F j - g:i A')]
        );
        $this->assertEquals(
            0,
            $response->original['value']->trend[Chronos::now()->setTimezone(
                'America/Chicago'
            )->subMinutes(2)->format('F j - g:i A')]
        );
        $this->assertEquals(
            0,
            $response->original['value']->trend[Chronos::now()->setTimezone(
                'America/Chicago'
            )->subMinutes(1)->format('F j - g:i A')]
        );
        $this->assertEquals(
            1,
            $response->original['value']->trend[Chronos::now()->setTimezone('America/Chicago')->format(
    ...
    public function test_trend_average_can_be_retrieved_by_month($date)
    {
        ...
        $this->assertEquals(
            150,
            $response->original['value']->trend[Chronos::now()->subMonths(5)->addDays(3)->format('F Y')]
        );
    ...
    public function test_trend_sum_can_be_retrieved_by_hour($date)
    {
        ...
        $this->assertEquals(
            650,
            $response->original['value']->trend[Chronos::now()->subHours(5)->format('F j - G:00')]
        );
        $this->assertEquals(
            50000,
            $response->original['value']->trend[Chronos::now()->subHours(4)->format('F j - G:00')]
        );
