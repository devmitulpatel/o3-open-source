...
class ActionControllerTest extends IntegrationTest
{
    ...
    public function test_standalone_actions_can_be_applied()
    {
        $response = $this->withoutExceptionHandling()
            ->post(
                '/nova-api/users/action?action=' . (new StandaloneAction)->uriKey(),
                [
                    'resources' => '',
                    'name' => 'Taylor Otwell',
    ...
    public function test_actions_support_opening_in_a_new_tab()
    {
        ...
        $response = $this->withExceptionHandling()
            ->post(
                '/nova-api/users/action?action=' . (new OpensInNewTabAction)->uriKey(),
                [
                    'resources' => implode(',', [$user->id]),
                ]
            );
    ...
    public function test_action_fields_are_validated()
    {
        ...
        $response = $this->withExceptionHandling()
            ->postJson(
                '/nova-api/users/action?action=' . (new RequiredFieldAction)->uriKey(),
                [
                    'resources' => implode(',', [$user->id, $user2->id]),
                    'test' => '',
                    'callback' => '',
    ...
    public function test_destructive_action_cant_be_applied_if_not_authorized_to_delete_resource()
    {
        ...
        $response = $this->withExceptionHandling()
            ->post(
                '/nova-api/users/action?action=' . (new DestructiveAction)->uriKey(),
                [
                    'resources' => $user->id,
                    'test' => 'Taylor Otwell',
                    'callback' => '',
    ...
    public function test_action_cant_be_applied_if_not_authorized_to_run_action()
    {
        ...
        $response = $this->withExceptionHandling()
            ->post(
                '/nova-api/users/action?action=' . (new UnrunnableAction)->uriKey(),
                [
                    'resources' => $user->id,
                    'test' => 'Taylor Otwell',
                    'callback' => '',
    ...
    public function test_action_cant_be_applied_if_not_authorized_to_run_destructive_action()
    {
        ...
        $response = $this->withExceptionHandling()
            ->post(
                '/nova-api/users/action?action=' . (new UnrunnableDestructiveAction)->uriKey(),
                [
                    'resources' => $user->id,
                    'test' => 'Taylor Otwell',
                    'callback' => '',
    ...
    public function test_actions_cant_be_run_if_they_are_not_authorized_to_see_the_action()
    {
        ...
        $response = $this->withExceptionHandling()
            ->post(
                '/nova-api/users/action?action=' . (new UnauthorizedAction)->uriKey(),
                [
                    'resources' => implode(',', [$user->id]),
                    'test' => 'Taylor Otwell',
                    'callback' => '',
    ...
    public function test_actions_can_be_applied_to_an_entire_resource_with_relationship_constraint()
    {
        ...
        $response = $this->withExceptionHandling()
            ->post(
                '/nova-api/comments/action?action=' . (new NoopAction)->uriKey(
                ) . '&viaResource=posts&viaResourceId=' . $post->id . '&viaRelationship=comments',
                [
                    'resources' => 'all',
                    'test' => 'Taylor Otwell',
                ]
    ...
    public function test_actions_can_be_applied_to_an_entire_resource_with_search_constraint()
    {
        ...
        $response = $this->withExceptionHandling()
            ->post(
                '/nova-api/comments/action?action=' . (new NoopAction)->uriKey() . '&search=Comment 1',
                [
                    'resources' => 'all',
                    'test' => 'Taylor Otwell',
                ]
    ...
    public function test_actions_can_be_applied_to_an_entire_resource_with_filter_constraint()
    {
        ...
        $response = $this->withExceptionHandling()
            ->post(
                '/nova-api/comments/action?action=' . (new NoopAction)->uriKey() . '&filters=' . $filters,
                [
                    'resources' => 'all',
                    'test' => 'Taylor Otwell',
                ]
    ...
    public function test_actions_can_be_applied_to_an_entire_resource_with_search_and_filter_constraint()
    {
        ...
        $response = $this->withExceptionHandling()
            ->post(
                '/nova-api/comments/action?action=' . (new NoopAction)->uriKey(
                ) . '&search=Comment 2&filters=' . $filters,
                [
                    'resources' => 'all',
                    'test' => 'Taylor Otwell',
                ]
    ...
    public function test_actions_can_be_applied_to_soft_deleted_resources()
    {
        ...
        $response = $this->withExceptionHandling()
            ->post(
                '/nova-api/users/action?action=' . (new NoopAction)->uriKey() . '&trashed=with',
                [
                    'resources' => implode(',', [$user->id, $user2->id]),
                    'test' => 'Taylor Otwell',
                    'callback' => '',
    ...
    public function test_action_event_not_created_if_action_fails()
    {
        ...
        $response = $this->withExceptionHandling()
            ->post(
                '/nova-api/users/action?action=' . (new ExceptionAction)->uriKey(),
                [
                    'resources' => $user->id,
                ]
            );
    ...
    public function test_actions_can_update_single_event_statuses()
    {
        ...
        $response = $this->withExceptionHandling()
            ->post(
                '/nova-api/users/action?action=' . (new UpdateStatusAction)->uriKey(),
                [
                    'resources' => implode(',', [$user->id, $user2->id]),
                ]
            );
    ...
    public function test_queued_actions_can_be_dispatched_for_an_entire_resource()
    {
        ...
        $response = $this->withExceptionHandling()
            ->post(
                '/nova-api/users/action?action=' . (new QueuedResourceAction)->uriKey(),
                [
                    'resources' => 'all',
                    'test' => 'Taylor Otwell',
                ]
    ...
    public function test_queued_actions_can_be_dispatched_for_soft_deleted_resources()
    {
        ...
        $response = $this->withExceptionHandling()
            ->post(
                '/nova-api/users/action?action=' . (new QueuedAction)->uriKey() . '&trashed=with',
                [
                    'resources' => implode(',', [$user->id, $user2->id]),
                    'test' => 'Taylor Otwell',
                    'callback' => '',
    ...
    public function test_queued_actions_can_update_single_event_statuses()
    {
        ...
        $response = $this->withExceptionHandling()
            ->post(
                '/nova-api/users/action?action=' . (new QueuedUpdateStatusAction)->uriKey(),
                [
                    'resources' => implode(',', [$user->id, $user2->id]),
                ]
            );
    ...
    public function test_actions_can_ignore_action_event()
    {
        ...
        $response = $this->withExceptionHandling()
            ->post(
                '/nova-api/users/action?action=' . (new NoopActionWithoutActionable())->uriKey(),
                [
                    'resources' => implode(',', [$user->id, $user2->id]),
                ]
            );
    ...
    public function test_actions_handle_result()
    {
        ...
        $response = $this->withExceptionHandling()
            ->post(
                '/nova-api/users/action?action=' . (new HandleResultAction())->uriKey(),
                [
                    'resources' => 'all',
                ]
            );
