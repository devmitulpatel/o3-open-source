...
class TextTest extends IntegrationTest
{
    public function test_field_does_not_output_suggestions_for_index_request()
    {
        ...
        $this->assertSame(
            '{"attribute":"title","component":"text-field","helpText":null,"indexName":"Title","name":"Title","nullable":false,"panel":null,"prefixComponent":true,"readonly":false,"required":false,"sortable":false,"sortableUriKey":"title","stacked":false,"textAlign":"left","validationKey":"title","value":"Hello World"}',
            json_encode($field)
        );
    }
    ...
    public function test_field_output_suggestions_for_create_request()
    {
        ...
        $this->assertSame(
            '{"attribute":"title","component":"text-field","helpText":null,"indexName":"Title","name":"Title","nullable":false,"panel":null,"prefixComponent":true,"readonly":false,"required":false,"sortable":false,"sortableUriKey":"title","stacked":false,"textAlign":"left","validationKey":"title","value":"Hello World","suggestions":["Foobar"]}',
            json_encode($field)
        );
    }
